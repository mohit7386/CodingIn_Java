    ...
    public static void main(String[] args){
        ...
        switch(button){ //here in bracket we use our variable name
            case 1: //switch has cases
                ...
                break; //break is used to terminate the case1 and exit the code...always use break after one statement
            case 2:
            ...
            case 3:
                ...
                break;
            default: //this is the default case same as like an else case, so here you don't need to use break.
